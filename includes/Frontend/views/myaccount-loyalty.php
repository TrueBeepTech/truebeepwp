...
<div class="truebeep-loyalty-account">
    ...
    <div class="loyalty-overview">
        <div class="loyalty-card points-balance">
            ...
            <div class="card-content">
                <h3><?php _e('Available Points', 'truebeep'); ?></h3>
        ...
        <div class="loyalty-card tier-status">
            ...
            <div class="card-content">
                <h3><?php _e('Current Tier', 'truebeep'); ?></h3>
    ...
    <div class="loyalty-stats">
        <div class="stat-item">
            <span class="stat-label"><?php _e('Total Earned Points', 'truebeep'); ?></span>
            <span class="stat-value"><?php echo number_format($total_earned); ?></span>
        </div>
        <div class="stat-item">
            <span class="stat-label"><?php _e('Total Redeemed Points', 'truebeep'); ?></span>
    ...
    <div class="loyalty-wallets">
        <h3><?php _e('Add to Digital Wallet', 'truebeep'); ?></h3>
        <p><?php _e('Keep your loyalty card handy by adding it to your digital wallet.', 'truebeep'); ?></p>
        ...
        <div class="wallet-buttons">
            ...
            <a href="<?php echo esc_url($apple_wallet_url); ?>" class="wallet-btn apple-wallet" target="_blank" rel="noopener">
                ...
                <span><?php _e('Add to Apple Wallet', 'truebeep'); ?></span>
            </a>
            <?php endif; ?>
            ...
            <a href="<?php echo esc_url($google_wallet_url); ?>" class="wallet-btn google-wallet" target="_blank" rel="noopener">
                ...
                <span><?php _e('Add to Google Wallet', 'truebeep'); ?></span>
            </a>
            <?php endif; ?>
        </div>
    </div>
    ...
    <div class="loyalty-info">
        <h3><?php _e('How Loyalty Points Work', 'truebeep'); ?></h3>
        <div class="info-grid">
            <div class="info-item">
                <div class="info-icon">💰</div>
                <h4><?php _e('Earn Points', 'truebeep'); ?></h4>
                <p><?php _e('Earn points with every purchase. The more you shop, the more you earn!', 'truebeep'); ?></p>
            </div>
            <div class="info-item">
                <div class="info-icon">🎁</div>
                <h4><?php _e('Redeem Rewards', 'truebeep'); ?></h4>
                <p><?php _e('Use your points for discounts on future purchases at checkout.', 'truebeep'); ?></p>
            </div>
            <div class="info-item">
                <div class="info-icon">⭐</div>
                <h4><?php _e('Level Up', 'truebeep'); ?></h4>
                <p><?php _e('Reach higher tiers for better rewards and exclusive benefits.', 'truebeep'); ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="loyalty-transactions">
        <h3><?php _e('Recent Transactions', 'truebeep'); ?></h3>
        <table class="woocommerce-orders-table woocommerce-MyAccount-orders shop_table shop_table_responsive my_account_orders account-orders-table">
            <thead>
                <tr>
                    <th><?php _e('Date', 'truebeep'); ?></th>
                    <th><?php _e('Description', 'truebeep'); ?></th>
                    <th><?php _e('Points', 'truebeep'); ?></th>
                    <th><?php _e('Balance', 'truebeep'); ?></th>
                </tr>
            </thead>
            <tbody>
