...
<div class="truebeep-loyalty-account">
    ...
    <div class="loyalty-overview">
        <div class="loyalty-card points-balance">
            ...
            <div class="card-content">
                <h3><?php esc_html_e('Available Points', 'truebeep-smart-wallet-loyalty'); ?></h3>
        ...
        <div class="loyalty-card tier-status">
            ...
            <div class="card-content">
                <h3><?php esc_html_e('Current Tier', 'truebeep-smart-wallet-loyalty'); ?></h3>
    ...
    <div class="loyalty-stats">
        <div class="stat-item">
            <span class="stat-label"><?php esc_html_e('Total Earned Points', 'truebeep-smart-wallet-loyalty'); ?></span>
            <span class="stat-value"><?php echo number_format($total_earned); ?></span>
        </div>
        <div class="stat-item">
            <span class="stat-label"><?php esc_html_e('Total Redeemed Points', 'truebeep-smart-wallet-loyalty'); ?></span>
    ...
    <div class="loyalty-wallets">
        <h3><?php esc_html_e('Add to Digital Wallet', 'truebeep-smart-wallet-loyalty'); ?></h3>
        <p><?php esc_html_e('Keep your loyalty card handy by adding it to your digital wallet.', 'truebeep-smart-wallet-loyalty'); ?></p>
        ...
        <div class="wallet-buttons">
            ...
            <a href="<?php echo esc_url($apple_wallet_url); ?>" class="wallet-btn apple-wallet" target="_blank" rel="noopener">
                ...
                <span><?php esc_html_e('Add to Apple Wallet', 'truebeep-smart-wallet-loyalty'); ?></span>
            </a>
            <?php endif; ?>
            ...
            <a href="<?php echo esc_url($google_wallet_url); ?>" class="wallet-btn google-wallet" target="_blank" rel="noopener">
                ...
                <span><?php esc_html_e('Add to Google Wallet', 'truebeep-smart-wallet-loyalty'); ?></span>
            </a>
            <?php endif; ?>
        </div>
    </div>
    ...
    <div class="loyalty-info">
        <h3><?php esc_html_e('How Loyalty Points Work', 'truebeep-smart-wallet-loyalty'); ?></h3>
        <div class="info-grid">
            <div class="info-item">
                <div class="info-icon">💰</div>
                <h4><?php esc_html_e('Earn Points', 'truebeep-smart-wallet-loyalty'); ?></h4>
                <p><?php esc_html_e('Earn points with every purchase. The more you shop, the more you earn!', 'truebeep-smart-wallet-loyalty'); ?></p>
            </div>
            <div class="info-item">
                <div class="info-icon">🎁</div>
                <h4><?php esc_html_e('Redeem Rewards', 'truebeep-smart-wallet-loyalty'); ?></h4>
                <p><?php esc_html_e('Use your points for discounts on future purchases at checkout.', 'truebeep-smart-wallet-loyalty'); ?></p>
            </div>
            <div class="info-item">
                <div class="info-icon">⭐</div>
                <h4><?php esc_html_e('Level Up', 'truebeep-smart-wallet-loyalty'); ?></h4>
                <p><?php esc_html_e('Reach higher tiers for better rewards and exclusive benefits.', 'truebeep-smart-wallet-loyalty'); ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="loyalty-transactions">
        <h3><?php esc_html_e('Recent Transactions', 'truebeep-smart-wallet-loyalty'); ?></h3>
        <table class="woocommerce-orders-table woocommerce-MyAccount-orders shop_table shop_table_responsive my_account_orders account-orders-table">
            <thead>
                <tr>
                    <th><?php esc_html_e('Date', 'truebeep-smart-wallet-loyalty'); ?></th>
                    <th><?php esc_html_e('Description', 'truebeep-smart-wallet-loyalty'); ?></th>
                    <th><?php esc_html_e('Points', 'truebeep-smart-wallet-loyalty'); ?></th>
                    <th><?php esc_html_e('Balance', 'truebeep-smart-wallet-loyalty'); ?></th>
                </tr>
            </thead>
            <tbody>
