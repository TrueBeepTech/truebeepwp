...
<div class="<?php echo esc_attr(implode(' ', $truebeep_container_classes)); ?>">
    ...
    <div class="loyalty-wallet-section">
        <h4><?php esc_html_e('Add your loyalty card to your digital wallet', 'truebeep-smart-wallet-loyalty'); ?></h4>
        ...
        <div class="wallet-buttons-dashboard">
            ...
            <a href="<?php echo esc_url($apple_wallet_url); ?>" class="wallet-btn-dashboard apple-wallet" target="_blank" rel="noopener">
                ...
                <span><?php esc_html_e('Apple Wallet', 'truebeep-smart-wallet-loyalty'); ?></span>
            </a>
            <?php endif; ?>
            ...
            <a href="<?php echo esc_url($google_wallet_url); ?>" class="wallet-btn-dashboard google-wallet" target="_blank" rel="noopener">
                ...
                <span><?php esc_html_e('Google Wallet', 'truebeep-smart-wallet-loyalty'); ?></span>
            </a>
            <?php endif; ?>
        </div>
    </div>
