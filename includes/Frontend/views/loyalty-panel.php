<div id="truebeep-loyalty-panel" class="truebeep-loyalty-panel <?php echo esc_attr($panel_position); ?>" data-customer-id="<?php echo esc_attr($truebeep_customer_id); ?>">
    ...
    <div class="panel-content">
        <div class="panel-header">
            <h3><?php _e('Your Rewards', 'truebeep'); ?></h3>
        ...
        <div class="panel-body">
            <div class="loyalty-info">
                <div class="points-section">
                    <div class="points-label"><?php _e('Available Points', 'truebeep'); ?></div>
                ...
                <div class="tier-section">
                    <div class="tier-label"><?php _e('Your Tier', 'truebeep'); ?></div>
                    <div class="tier-value">--</div>
                </div>
            </div>

            <div class="wallet-section">
                <h4><?php _e('Add to Wallet', 'truebeep'); ?></h4>
                <div class="wallet-buttons">
                    <a href="#" class="wallet-btn apple-wallet" target="_blank" rel="noopener">
                        ...
                        <span><?php _e('Apple Wallet', 'truebeep'); ?></span>
                    </a>
                    ...
                    <a href="#" class="wallet-btn google-wallet" target="_blank" rel="noopener">
                        ...
                        <span><?php _e('Google Wallet', 'truebeep'); ?></span>
                    </a>
                </div>
            </div>

            <div class="panel-footer" style="display: none;">
                <a href="<?php echo esc_url(wc_get_account_endpoint_url('loyalty')); ?>" class="view-history-link">
                    <?php _e('View Points History', 'truebeep'); ?> →
                </a>
            </div>
        </div>
