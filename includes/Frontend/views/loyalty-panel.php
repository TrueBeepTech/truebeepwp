            ...
            <div class="wallet-buttons">
                <a href="#" class="wallet-btn apple-wallet" target="_blank" rel="noopener">
                    ...
                    <div class="wallet-text">
                        <span class="add-to-text"><?php _e('Add to', 'truebeep'); ?></span>
                        <span class="wallet-name"><?php _e('Apple Wallet', 'truebeep'); ?></span>
                    </div>
                </a>
                ...
                <a href="#" class="wallet-btn google-wallet" target="_blank" rel="noopener">
                    ...
                    <div class="wallet-text">
                        <span class="add-to-text"><?php _e('Add to', 'truebeep'); ?></span>
                        <span class="wallet-name"><?php _e('Google Wallet', 'truebeep'); ?></span>
                    </div>
                </a>
            </div>
        </div>
